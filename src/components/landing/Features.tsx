...
import { BarChart3, Users, Receipt, Package, CreditCard, Sparkles, LucideIcon } from 'lucide-react';
...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: "Auto-scan receipts, smart categorization, and an AI assistant to answer your financial questions.",
    icon: Sparkles
  }
];
